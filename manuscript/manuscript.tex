...
\begin{table}[htbp]
\centering
\caption{Head-to-head noise mitigation comparison showing the recovery breakdown brackets $[$Fail, Succeed$]$ (at $5$ dB resolution using $500$ trials for pointwise and weak-form, and coarse SNR cutoffs for others). The weak-form $\alpha_t = 0.5$ fail edge ($15$ dB, $79.0\%$ success $<95\%$) was established by extending the sweep below the original $20$ dB floor; all three weak-form orders share the same $[15\text{ dB}, 20\text{ dB}]$ bracket.}

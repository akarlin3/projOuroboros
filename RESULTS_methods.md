...
* **Candidate Sweep**: Candidates swept from $0.4$ to $1.0$ in steps of $0.1$.
* **Clean Data Recovery**:
  * **$\alpha_t = 0.5$**: Selected order $\hat{\alpha}_t = 0.5$ (Error $= 0.0000$), $R^2$ Margin over next best $= 0.0014$.
  * **$\alpha_t = 0.7$**: Selected order $\hat{\alpha}_t = 0.7$ (Error $= 0.0000$), $R^2$ Margin over next best $= 0.0891$.
  * **$\alpha_t = 0.9$**: Selected order $\hat{\alpha}_t = 0.9$ (Error $= 0.0000$), $R^2$ Margin over next best $= 1.2169$.
* **Noise Sweep (Sensitivity Limits)**:
  Gaussian measurement noise was added to the clean state trajectories at several Signal-to-Noise Ratios (SNRs):
  ...
  | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
  | **0.5** | 0.5 ($R^2=0.999$) | 0.5 ($R^2=0.993$) | 0.5 ($R^2=0.766$) | 0.4 ($R^2=0.461$) | 0.4 ($R^2=0.613$) | **60 dB** |
  | **0.7** | 0.7 ($R^2=0.999$) | 0.7 ($R^2=0.993$) | 0.6 ($R^2=0.765$) | 0.4 ($R^2=0.521$) | 0.4 ($R^2=0.511$) | **80 dB** |
  | **0.9** | 0.9 ($R^2=0.999$) | 0.9 ($R^2=0.985$) | 0.9 ($R^2=0.498$) | 0.8 ($R^2=0.281$) | 0.4 ($R^2=0.445$) | **60 dB** |

* **Methodological Finding**: The fractional-SINDy framework has excellent sensitivity on clean data, but breaks down under moderate noise (SNR $\le 40$ dB). Because the GL fractional derivative is a history-dependent sum, it amplifies noise (especially at lower orders or very small step sizes), causing SINDy to under-select the order ($\hat{\alpha}_t \to 0.4$).
